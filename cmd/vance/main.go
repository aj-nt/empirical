...
func main() {
	// JD Vance natal: Aug 2, 1984, 12:11 UT, Middletown OH
	natalTime := time.Date(1984, 8, 2, 12, 11, 0, 0, time.UTC)
	natalLat, natalLon := 39.5, -84.4
	...
	fmt.Println("=== JD VANCE NATAL CHART ===")
	fmt.Printf("Date: Aug 2, 1984 12:11 UT  |  Middletown, OH\n")
