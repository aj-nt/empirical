...
var StarNames = []string{
	...
	"Al Hecka", "Albireo", "Alcor", "Alcyone", "Aldebaran", "Algenib", "Algieba", "Algol", "Algorab", "Alhena",
	"Alioth", "Alkaid", "Alkes", "Alnilam", "Alnitak", "Alpha Centauri",
	"Alphard", "Alphecca", "Alpheratz", "Alsephina", "Altair", "Antares", "Arcturus",
	...
	"Fomalhaut", "Gacrux", "Gienah", "Hamal", "Hatsya", "Heze", "Izar",
	"Kaus Australis", "Kaus Borealis", "Kaus Media", "Kochab", "Kraz", "Labrum", "Maia",
	"Markab", "Markeb", "Megrez", "Menkar", "Menkent", "Menkib", "Merak",
	"Merope", "Miaplacidus", "Mimosa", "Mintaka", "Mira", "Mirach", "Mirfak",
	"Mizar", "Muphrid", "Nair al Saif", "Nashira", "Nekkar", "Nunki", "Peacock",
	"Phact", "Phecda", "Polaris", "Pollux", "Porrima", "Procyon", "Ras Elased Aust", "Rasalhague", "Rastaban",
	"Regulus", "Rigel", "Ruchbah", "Ruchba", "Sabik", "Sadachbia",
	"Sadalmelik", "Sadalsuud", "Sadr", "Saiph", "Scheat", "Schedar", "Seginus",
	"Shaula", "Sheliak", "Sirius", "Skat", "Spica", "Subra", "Suhail",
...
var StarMeanings = map[string]string{
	...
	"Al Hecka":       "Mars nature. The Horn. Aggressive energy, sharp intellect. 'The Driving Horn.' Forceful action, competitive drive, the capacity to pierce through obstacles.",
	...
	"Alcor":          "Mars-Mercury nature. The Rider's companion. Keen perception, the ability to see what others miss. 'The Test.' Sharp eyesight — literal and metaphorical. Discernment under pressure.",
	...
	"Algenib":        "Mars-Mercury nature. The Wingtip. Swift thought, restless intellect. 'The Side.' Mental agility, the capacity to pivot quickly. Liability to scattered focus.",
	"Algieba":        "Saturn-Mars nature. The Lion's mane. Power, violence, but also creative force. 'The Forehead.' Dignity, authority, the capacity to command. The lion's brow.",
	"Algol":          "Saturn-Jupiter nature. The Demon Star. 'The Ghoul.' The most notorious star in astrology — the severed head of Medusa. Intense, transformative, potentially destructive energy. Associated with violence, passion, and the loss of the head (literal or metaphorical). In opposition to Mars, the capacity for explosive action that can destroy or liberate. Requires conscious channeling.",
	"Algorab":        "Mars-Saturn nature. The Crow's wing. Harsh judgment, the capacity to see what's wrong. 'The Raven.' Critical intelligence, the part of the mind that finds flaws. Liability to cynicism.",
	...
	"Alphecca":       "Venus-Mercury nature. The Crown. Artistic talent, honor, recognition. 'The Bright One of the Broken Ring.' Achievement that comes through creative expression. The poet's laurel.",
	"Alpheratz":      "Jupiter-Venus nature. The Horse's Navel. Independence, freedom, swift movement. 'The Shoulder of Pegasus.' Grace under pressure, the capacity to move between worlds. Success through self-directed action.",
	...
	"Hatsya":         "Jupiter-Saturn nature. The Bright One. 'The Tip of the Water Jar.' Illumination through discipline. Wisdom that comes from sustained effort. The capacity to hold and distribute knowledge.",
	...
	"Kraz":           "Saturn nature. The Claw. 'The Southern Claw.' Restriction, discipline, the capacity to grip and hold. Tenacity that borders on obsession. The part of the chart that won't let go.",
	...
	"Megrez":         "Mars nature. The Tail Root. 'The Base of the Bear's Tail.' Quiet strength, the capacity to anchor. The least bright of the Big Dipper stars — power that doesn't announce itself. Steadiness under pressure.",
	...
	"Mira":           "Jupiter-Saturn nature. The Wonderful. 'The Amazing One.' A variable star — brightness that waxes and wanes. Cycles of visibility and obscurity. The capacity to reappear after disappearance. Resilience through periodic renewal.",
	...
	"Nair al Saif":   "Jupiter-Saturn nature. The Bright One of the Sword. 'The Sword's Tip.' Precision, the capacity to cut through. Sharp judgment, decisive action. The point where analysis becomes execution.",
	...
	"Phact":          "Venus-Mercury nature. The Ring Dove. Peace, beauty, the capacity to bridge. 'The Dove.' Gentle communication that achieves what force cannot. Diplomacy, grace, the messenger of peace.",
	"Phecda":         "Mars nature. The Thigh. 'The Bear's Thigh.' Physical strength, endurance, the capacity to carry weight. The part of the chart that bears the load. Stamina that outlasts opposition.",
	"Polaris":        "Saturn-Jupiter nature. The Pole Star. 'The Guiding Star.' Constancy, direction, the fixed point around which everything turns. The capacity to hold steady while the world rotates. Navigation, purpose, unwavering focus.",
	...
	"Sadr":           "Venus-Mercury nature. The Breast. 'The Hen's Breast.' Nurturing wisdom, the capacity to sustain. The heart of the Swan. Grace that feeds others. Emotional intelligence expressed through care.",
	...
	"Sheliak":        "Venus-Mercury nature. The Lyre. 'The Tortoise Shell.' Artistic talent, the capacity to create beauty from structure. The harp of Orpheus. Music, poetry, the arts — creative expression that follows form.",
